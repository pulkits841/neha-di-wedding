/**
 * @author Pulkit Sharma <pulkitsharma841@gmail.com>
 */
(function ($) {
    "use strict";
...
var countDownDate = new Date("Feb 07, 2025 00:00:00").getTime();
...
console.log('\n\n%c SAVE THE DATE: 07th Feb, 2025!', styles);
...
$(document).ready(function () {
    // Sakura falling animation (already present)
    $('.sakura-falling').sakura();
 
    // Add a smooth fade-in for the timeline section
